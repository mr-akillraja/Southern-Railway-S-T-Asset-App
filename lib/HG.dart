...
class HG_Details extends StatefulWidget {
  @override
  _HGState createState() => _HGState();
}

class _HGState extends State<HG_Details> {
  ...
  Future<void> saveDataToFirestore() async {
    try {
      await FirebaseFirestore.instance.collection('HG_Details').add({
        'pfNumber':
  ...
  Future<void> updateDataInFirestore() async {
    try {
      CollectionReference collectionRef =
          FirebaseFirestore.instance.collection('HG_Details');

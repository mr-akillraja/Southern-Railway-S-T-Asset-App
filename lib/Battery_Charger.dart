...
class Battery_Charger_Details extends StatefulWidget {
  @override
  _Battery_Charger_state createState() => _Battery_Charger_state();
}

class _Battery_Charger_state extends State<Battery_Charger_Details> {
  ...
  final batterytypeController = TextEditingController();
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      labelText: "Maker of Charger/IPS",
                      border: OutlineInputBorder(),
                      labelStyle:
                          TextStyle(color: const Color.fromARGB(209, 0, 0, 0)),
                    ),
                  ...
                  TextFieldWithOptions(
                    ...
                    options: ['Select Option', 'LMLA', 'VRLA'],
                    onChanged: (String? newValue) {
                      setState(() {
                        if (newValue == 'Select Option') {
                          batterytypeController.clear();
                        } else {
                          batterytypeController.text = newValue!;
                        }
                      });
                    },
  ...
  Future<void> saveDataToFirestore() async {
    try {
      await FirebaseFirestore.instance
          .collection('Battery_Charger_Details')
          .add({
        'pfNumber':
        ...
        'Maker of Charger/IPS': makerController.text,
        'Capacity': capacityController.text,
        'Battery Type': batterytypeController.text,
  ...
  Future<void> updateDataInFirestore() async {
    try {
      CollectionReference collectionRef =
          FirebaseFirestore.instance.collection('Battery_Charger_Details');
      ...
      querySnapshot.docs.forEach((doc) {
        if (doc.reference == newDocRef) {
          ...
          setState(() {
            ...
            makerController.text = data['Maker of Charger/IPS'] ?? '';
            capacityController.text = data['Capacity'] ?? '';
            circuitController.text = data["Circuit"] ?? '';
            batterytypeController.text = data['Battery Type'] ?? '';

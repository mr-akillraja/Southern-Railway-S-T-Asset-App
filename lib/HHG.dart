...
class HHG_Details extends StatefulWidget {
  @override
  _HHGState createState() => _HHGState();
}

class _HHGState extends State<HHG_Details> {
  ...
  Future<void> saveDataToFirestore() async {
    try {
      await FirebaseFirestore.instance.collection('HHG_Details').add({
        'pfNumber':
  ...
  Future<void> updateDataInFirestore() async {
    try {
      CollectionReference collectionRef =
          FirebaseFirestore.instance.collection('HHG_Details');

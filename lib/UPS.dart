...
class UPS_Details extends StatefulWidget {
  @override
  _UPS_State createState() => _UPS_State();
}

class _UPS_State extends State<UPS_Details> {
  ...
  Future<void> saveDataToFirestore() async {
    try {
      await FirebaseFirestore.instance.collection('DG_Details').add({
        'pfNumber':
  ...
  Future<void> updateDataInFirestore() async {
    try {
      CollectionReference collectionRef =
          FirebaseFirestore.instance.collection('DG_Details');

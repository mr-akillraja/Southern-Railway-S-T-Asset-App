...
class Calling_on_Details extends StatefulWidget {
  @override
  _Calling_on_State createState() => _Calling_on_State();
}

class _Calling_on_State extends State<Calling_on_Details> {
  ...
  final singalnoController = TextEditingController();
  ...
  Future<void> saveDataToFirestore() async {
    try {
      await FirebaseFirestore.instance.collection('A_Marker_Details').add({
        'pfNumber':
  ...
  Future<void> updateDataInFirestore() async {
    try {
      CollectionReference collectionRef =
          FirebaseFirestore.instance.collection('A_Marker_Details');

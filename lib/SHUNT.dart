...
class Shunt_Details extends StatefulWidget {
  @override
  _ShuntState createState() => _ShuntState();
}

class _ShuntState extends State<Shunt_Details> {
  ...
  Future<void> saveDataToFirestore() async {
    try {
      await FirebaseFirestore.instance.collection('Shunt_Details').add({
        'pfNumber':
  ...
  Future<void> updateDataInFirestore() async {
    try {
      CollectionReference collectionRef =
          FirebaseFirestore.instance.collection('Shunt_Details');

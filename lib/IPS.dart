...
import 'main.dart'; // Import your PFNumberProvider class
...
class IPS_Details extends StatefulWidget {
  @override
  _IPS_State createState() => _IPS_State();
}

class _IPS_State extends State<IPS_Details> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                if (isDataExist) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('No data found for the given Station'),
                    ),
                  );
                }
              },
            ...
            ElevatedButton(
              onPressed:
                  isDataExist ? updateDataInFirestore : saveDataToFirestore,

...
class RG_Details extends StatefulWidget {
  @override
  _RGState createState() => _RGState();
}

class _RGState extends State<RG_Details> {
  ...
  Future<void> saveDataToFirestore() async {
    try {
      await FirebaseFirestore.instance.collection('RG_Details').add({
        'pfNumber':
  ...
  Future<void> updateDataInFirestore() async {
    try {
      CollectionReference collectionRef =
          FirebaseFirestore.instance.collection('RG_Details');
